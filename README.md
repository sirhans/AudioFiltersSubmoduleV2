...
For the optimized feedback-delay reverb, configurable delay units, safe parameter
handoff and sixteen-candidate bass selection, see [BMOptimizedReverb](BMOptimizedReverb.md).
