 ...
 * @param qualityGoal the function will stop searching and return a result immediately if it finds something that is as at least as good as this quality goal.
 *
