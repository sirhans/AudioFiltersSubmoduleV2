...
extern "C" {
    ...
    void BMOscillatorArray_init(BMOscillatorArray *This,
        ...
        // allocate memory
        This->m11 = malloc(sizeof(double)*length);
        This->m12 = malloc(sizeof(double)*length);
        This->m21 = malloc(sizeof(double)*length);
        This->m22 = malloc(sizeof(double)*length);
        This->temp = malloc(sizeof(double)*length);
        This->r = malloc(sizeof(double)*length);
        This->q = malloc(sizeof(double)*length);
    ...
    void BMOscillatorArray_processSample(BMOscillatorArray *This,
        ...
        //
        // temp = r*11 + q*12
        vDSP_vmmaD(This->r, 1, This->m11, 1,
                  This->q, 1, This->m12, 1,
                  This->temp, 1, This->length);
        
        // q = r*21 + q*22
        vDSP_vmmaD(This->r, 1, This->m21, 1,
                  This->q, 1, This->m22, 1,
        ...
        // output = sum(r);
        vDSP_sveD(This->r, 1, output, This->length);
    }
